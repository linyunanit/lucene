...
import static org.apache.lucene.codecs.customcompression.LuceneCustomCompressionCodec.Mode.ZSTD_DICT;
 ...
 */
public class LuceneCustomCompressionStoredFieldsFormat extends StoredFieldsFormat {
  // chunk size for zstandard
  private static final int ZSTD_BLOCK_LENGTH = 10 * 48 * 1024;

  public static final String MODE_KEY = LuceneCustomCompressionStoredFieldsFormat.class.getSimpleName() + ".mode";

  final LuceneCustomCompressionCodec.Mode mode;

  private int compressionLevel;

  /** default constructor */
  public LuceneCustomCompressionStoredFieldsFormat() {
    this(ZSTD_DICT, LuceneCustomCompressionCodec.defaultCompressionLevel);
  }

  /** Stored fields format with specified compression algo. */
  public LuceneCustomCompressionStoredFieldsFormat(LuceneCustomCompressionCodec.Mode mode, int compressionLevel) {
  ...
  public StoredFieldsReader fieldsReader(
    ...
    LuceneCustomCompressionCodec.Mode mode = LuceneCustomCompressionCodec.Mode.valueOf(value);
  ...
  StoredFieldsFormat impl(LuceneCustomCompressionCodec.Mode mode) {
    switch (mode) {
      case ZSTD:
